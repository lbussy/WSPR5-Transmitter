...
// static constexpr const char* PCI_RESOURCE_PATH = "/sys/bus/pci/devices/0000:01:00.0/resource1"; <- This was the SSD.  Bad bad bad.
//
// $ lspci -nn
// 0001:00:00.0 PCI bridge [0604]: Broadcom Inc. and subsidiaries BCM2712 PCIe Bridge [14e4:2712] (rev 21)
// 0001:01:00.0 Non-Volatile memory controller [0108]: Micron Technology Inc 2550 NVMe SSD (DRAM-less) [1344:5416] (rev 01)
...
// 
// Even though 0002:01:00.0 shows up as an “Ethernet controller,” that is in
// fact the RP1’s PCIe South Bridge device (which provides the PIO/DMA BARs
// as well as the built-in Gigabit MAC).
//
// $ ls -l /sys/bus/pci/devices/0002:01:00.0/resource*
// -r--r--r-- 1 root root   16384 May 24 07:48 /sys/bus/pci/devices/0002:01:00.0/resource
// -rw------- 1 root root   16384 May 24 07:48 /sys/bus/pci/devices/0002:01:00.0/resource0
// -rw------- 1 root root 4194304 May 24 07:48 /sys/bus/pci/devices/0002:01:00.0/resource1
// -rw------- 1 root root   65536 May 24 07:48 /sys/bus/pci/devices/0002:01:00.0/resource2
//
// That 4 MiB resource1 file is exactly the RP1’s BAR1 window – it’s the one
// you want for all those PIO and DMA register offsets (your code only ever
// mmaps the first 2 MiB of it). The smaller resource0 (16 KiB) is the PCI
// config or other minor region; resource2 is something else (e.g. the
// Ethernet MAC registers).
//
static constexpr const char* PCI_RESOURCE_PATH = "/sys/bus/pci/devices/0002:01:00.0/resource1";
